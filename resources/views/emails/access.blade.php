...
<head>
    ...
    <style>
        ...
        .btn { display: inline-block; padding: 12px 24px; background: #0077B6; color: #fff; text-decoration: none; border-radius: 5px; font-weight: bold; }
...
<body>
    <div class="container">
        ...
        <p>Terima kasih telah berlangganan <strong>Wamaps Lifetime Deal</strong>. Akun Anda telah berhasil diaktifkan dan siap digunakan.</p>
