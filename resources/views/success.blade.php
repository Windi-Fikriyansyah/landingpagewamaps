...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:wght@400;500;600;700;800&family=Manrope:wght@800&display=swap" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@24,400,1,0" rel="stylesheet">
    <script src="https://cdn.jsdelivr.net/npm/canvas-confetti@1.6.0/dist/confetti.browser.min.js"></script>
    <style>
        body { font-family: 'Plus Jakarta Sans', sans-serif; background-color: #f8fafc; }
        .success-card { animation: slideUp 0.6s cubic-bezier(0.16, 1, 0.3, 1); }
...
<body class="flex items-center justify-center min-h-screen p-4 overflow-hidden">
    <div class="max-w-md w-full success-card">
        <div class="bg-white rounded-[2.5rem] p-10 shadow-[0_20px_50px_rgba(0,119,182,0.1)] border border-blue-50 text-center relative overflow-hidden">
            <!-- Decorative circle -->
            <div class="absolute -top-12 -right-12 w-32 h-32 bg-blue-50 rounded-full opacity-50"></div>
            
            <!-- Success Icon -->
            <div class="w-24 h-24 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-8 relative z-10">
            ...
            <p class="text-slate-500 mb-10 leading-relaxed">Selamat! Akses <strong>Wamaps Lifetime Access</strong> Anda telah diaktifkan secara otomatis.</p>
            ...
            <div class="bg-slate-50 rounded-3xl p-6 mb-10 text-left border border-slate-100">
                ...
                <div class="flex justify-between items-center">
                    ...
                    <span class="px-3 py-1 bg-green-100 text-green-700 text-[10px] font-black uppercase rounded-full">Berhasil</span>
                </div>
            </div>
            ...
            <a href="{{ url('/login') }}" class="w-full py-4 px-8 bg-blue-600 text-white font-extrabold rounded-2xl hover:bg-blue-700 active:scale-[0.98] transition-all flex items-center justify-center gap-3 shadow-lg shadow-blue-200 group">
                Mulai Gunakan Wamaps
                <span class="material-symbols-outlined group-hover:translate-x-1 transition-transform">arrow_forward</span>
            </a>
            
            <p class="mt-8 text-xs text-slate-400 font-medium">Halaman ini akan menutup otomatis dalam <span id="timer">60</span> detik</p>
        </div>
    </div>
